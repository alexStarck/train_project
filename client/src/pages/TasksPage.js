...
export const TasksPage = () => {
    ...
    return (
        <div className="datatable-crud-demo">
            ...
            <Dialog visible={objectEditDialog} style={{width: '650px'}} header="Редактирование Задач" modal
                ...
                <div className="p-field" style={{height: height}}>
                    ...
                    <Dropdown value={valueComposition} options={valuesCom} onChange={(e) => {
                        onValueCompositionChange(e)
                ...
                {composition !== null && (composition.map((item, index) => {
                        ...
                        return (
                            <div className="p-mb-2 p-d-flex " key={index}>
                                <InputTextarea className="p-mr-2 p-d-inline-flex" rows={5} cols={30} value={item.name}
                                               onChange={(e) => onCompositionChange(e, item.number)} autoResize/>
                            </div>
                        )
                    })
                )}
            ...
            <Dialog visible={deleteObjectDialog} style={{width: '450px'}} header="Confirm" modal
            ...
            <Dialog visible={deleteObjectsDialog} style={{width: '450px'}} header="Confirm" modal
