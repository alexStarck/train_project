    ...
    return(
        <div className="datatable-crud-demo">
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={companiesList} selection={selectedCompanies} onSelectionChange={(e) =>{setSelectedCompanies(e.value)} }
            ...
            <Dialog visible={companyEditDialog} style={{ width: '450px' }} header="Company Details" modal className="p-fluid" footer={companyEditDialogFooter} onHide={hideDialog}>


                <div className="p-field">
                    <label htmlFor="name">Name</label>
                    <InputText id="name" value={company.name} onChange={(e) => onInputChange(e, 'name')} required autoFocus  />
                    {submitted && !company.name && <small className="p-error">Name is required.</small>}
                </div>
                <div className="p-field">
                    <label htmlFor="name">Name Object</label>
                    <InputText id="nameObject" value={company.nameObject} onChange={(e) => onInputChange(e, 'nameObject')} required autoFocus  />
